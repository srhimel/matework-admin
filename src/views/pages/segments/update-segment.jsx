...
const fakeSegment = {
  ...
  conditions: [
    ...
    {
      operand: 'AND',
      match_by: 'customer_orders_count',
      condition: 'is_greater_than',
      value: '52'
    },
    {
      operand: 'AND',
      match_by: 'cart_subtotal',
      condition: 'is_greater_than',
      value: '41'
    },
    {
    ...
    {
      operand: 'AND',
      match_by: 'customer_total_spent',
      condition: 'is_greater_than',
      value: '55'
    },
    {
      operand: 'AND',
      match_by: 'product_title',
      condition: 'contains',
      value: 'bbmnb'
    },
    {
      operand: 'OR IF',
      match_by: 'product_vendor',
      condition: 'contains',
      value: 'km'
    }
  ],
  expression: [
    'product_price === 10',
    'customer_orders_count > 52',
    'cart_subtotal > 41',
    'product_price > 10',
    'customer_total_spent > 55',
    "product_title.includes('bbmnb')",
    "product_vendor.includes('km')"
  ],
  condition_arr:
    "product_price === 10 && customer_orders_count > 52 && cart_subtotal > 41 || product_price > 10 && customer_total_spent > 55 && product_title.includes('bbmnb') || product_vendor.includes('km')",
  condition_operands: [' && ', ' && ', ' || ', ' && ', ' && ', ' || '],
  active_status: true
}
...
const UpdateSegment = () => {
  ...
  useEffect(() => {
    dispatch(
      saveCondition({
        name: fakeSegment.name,
        conditions: fakeSegment.conditions,
        active: fakeSegment.active_status
      })
    )
  }, [dispatch])
